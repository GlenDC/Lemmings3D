...
UIButtonWT::UIButtonWT(const int x, const int y, const tstring & name,  const UIDockInterface * pParrent, const tstring & asset_file,
...
void UIButtonWT::Draw(const GameContext & context)
{
	...
	SpriteBatch::DrawTextW(m_pFont.get(), m_Text, 
